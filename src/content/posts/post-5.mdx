...
<Img
      imgSourceLink={"https://www.thisday.app/"}
      imgSourceName={"thisday"}
    >
    <Image
        src={"https://cdn.thisday.app/media/uploads/Malushashi_06dcf7b516-2306a992_cmprssd.webp"}
        alt={"Malushahi and Rajula"}
        class={"object-cover p-0 w-full h-[60vh] object-top rounded-lg"}
        height={100}
        width={100}
      />
