/* empty css                          */
import { A as AstroError, l as UnknownContentCollectionError, f as createComponent, n as renderUniqueStylesheet, o as renderScriptElement, p as createHeadAndContent, r as renderTemplate, i as renderComponent, u as unescapeHTML, e as createAstro, m as maybeRenderHead, j as renderSlot, h as addAttribute } from '../astro_DVL52kWv.mjs';
import 'kleur/colors';
import pLimit from 'p-limit';
import { p as prependForwardSlash } from '../astro/assets-service_Bs7VlOHk.mjs';
import { n as name, d as description, k as keywords, u as url, a as $$Image, c as calculateReadingTime, $ as $$Layout } from './404_DDJa9XmF.mjs';
...
const contentEntryGlob = /* #__PURE__ */ Object.assign({"/src/content/posts/post-1.mdx": () => import('../post-1_BtjP_Z5_.mjs'),"/src/content/posts/post-2.mdx": () => import('../post-2_4lnsqIhb.mjs'),"/src/content/posts/post-3.mdx": () => import('../post-3_CFXR0vOu.mjs'),"/src/content/posts/post-4.mdx": () => import('../post-4_Bo2gC_8r.mjs'),"/src/content/posts/post-5.mdx": () => import('../post-5_DAUf-kkc.mjs'),"/src/content/posts/post-6.mdx": () => import('../post-6_D89W4WtE.mjs'),"/src/content/posts/post-7.mdx": () => import('../post-7_DIMaoK3w.mjs'),"/src/content/posts/post-8.mdx": () => import('../post-8_1_csV617.mjs')});
...
}, "C:/Users/singh/OneDrive/Desktop/pheres/src/components/blog/info.astro", void 0);
...
}, "C:/Users/singh/OneDrive/Desktop/pheres/src/components/meta.astro", void 0);
...
const $$Card = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a${addAttribute(link, "href")} class="lg:w-[320px] max-h-96 shadow-md flex flex-col items-center justify-center rounded-md gap-2 overflow-hidden bg-white"> <div class="w-full max-h-52 min-h-52 flex flex-col"> ${renderComponent($$result, "Image", $$Image, { "decoding": "async", "src": data.cover, "alt": "test", "class": "h-full w-full max-h-52 min-h-52 flex object-cover", "loading": loading, "height": 500, "width": 500 })} </div> <div class="w-full px-2 flex flex-col gap-2 my-1 h-60 justify-between"> <h3 class="font-bold text-lg line-clamp-2 min-h-14 max-h-14"> ${data.title} </h3> <p class="min-h-16 max-h-16 line-clamp-3 text-gray-500 text-sm"> ${data.description} </p> <div class="py-1"> ${renderComponent($$result, "Info", $$Info, { "pubDate": data.pubDate, "readingTime": readingTime })} </div> </div> </a>`;
}, "C:/Users/singh/OneDrive/Desktop/pheres/src/components/card.astro", void 0);
...
}, "C:/Users/singh/OneDrive/Desktop/pheres/src/pages/blogs.astro", void 0);

const $$file = "C:/Users/singh/OneDrive/Desktop/pheres/src/pages/blogs.astro";
const $$url = "/blogs";
